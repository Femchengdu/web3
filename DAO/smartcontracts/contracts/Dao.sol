...
contract MoralisDao {
    ...
    constructor(){
        ...
        validTokens = [26848454517621667175507242112331270997219441727981890049716604364689722310657]
    }
    ...
    function voteOnProposal(uint256 _id, bool _vote) public {
        require(Poroposals[_id].exists, "This Proposal does not exist");    
        require(checkProposalEligibility(msg.sender), "You can not vote on this Proposal");    
        require(!Proposals[_id].voteStatus[msg.sender], "You have already voted for this Proposals");    
